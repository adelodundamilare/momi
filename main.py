...
from app.endpoints import auth, account, utility, ingredient, formula, trend, chat, ai_insight, mock_consumer, social_post, consumer_insight, commercial_workflow, news_feed, insight_portal, supplier
